...
public class ItemCrafting {
    ...
    public static void init() {
        ...
        GameRegistry.addRecipe(new ShapelessOreRecipe(new ItemStack(ModItems.cutDriedTobacco, 5), craftingToolKnife, driedTobaccoStack));
        ...
        GT_Values.RA.stdBuilder()
            .itemInputs(GT_OreDictUnificator.get(OrePrefixes.dust, Materials.Wood, 5L),
                ItemList.Shape_Extruder_Pipe_Tiny.get(0L))
            .itemOutputs(new ItemStack(ModItems.celluloseAcetate, 1))
            .duration(15 * SECONDS).eut(TierEU.RECIPE_LV).addTo(extruderRecipes);

        // making tow
        GT_Values.RA.stdBuilder().itemInputs(new ItemStack(ModItems.celluloseAcetate, 5))
            .itemOutputs(new ItemStack(ModItems.tow, 1))
            .duration(20 * SECONDS).eut(TierEU.RECIPE_LV).addTo(compressorRecipes);

        // making filter rod
        GT_Values.RA.stdBuilder().itemInputs(new ItemStack(ModItems.tow, 1))
            .itemOutputs(new ItemStack(ModItems.filterRod, 1))
            .duration(20 * SECONDS).eut(TierEU.RECIPE_LV).addTo(wiremillRecipes);
